...
## ( [Click here to view the deployed website](https://heycss5.github.io/Software-Company-Website/) )
...
1. Clone the repo:
   ```sh
   git clone https://github.com/heycss5/Software-Company-Website.git
   ```
